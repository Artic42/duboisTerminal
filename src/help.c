...
int main (void)
{
    printf("--------- WELCOME TO THE LE SAPHIR BLEU ----------\n\n");
    printf("helpMe:           Display the help information in the terminal\n");
    printf("info:           Returns the information of the connected device\n");
    printf("deleteKeys:     Will delete the codes from the connected device if it is an activation device\n");
    ...
    printf("\n--------- BIENVENIDO A LE SAPHIR BLUE -------------\n\n");
    printf("ayudame:         Visualiza la información de ayuda en el terminal\n");
    printf("info:          Devuelve La informació del dispositivo conectado\n");
    printf("borrarCodigos: Borrará lo codigos del dispositivo conectado si este es un dispositio de activacón\n");
