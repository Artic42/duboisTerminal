...
int main (void)
{
    ...
    printf("Help:           Display the help information in the terminal\n");
    printf("Info:           Returns the information of the connected device\n");
    printf("DeleteCodes:    Will delete the codes from the connected device if it is an activation device\n");
    ...
    printf("Ayuda:         Visualiza la información de ayuda en el terminal\n");
